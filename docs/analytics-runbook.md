...
**Site:** angieqbailey.com **Last updated:** 2026-06-23 **Owner:** Angie Bailey
...
- `short_link_click`: emitted by the `/go/` stub template generated from `_links.json` via `scripts/build_links.py` (param `slug`, beacon transport). Live slugs as of 2026-06-23: `drs-maverick`, `drs-detective`, `drs-operator` (→ /rd/dignity/diagnostic-model.html) and `drs-rock` (→ /rd/dignity/rock-audit.html), separated by utm_campaign + slug. Plus an evergreen root vanity `/rock` (→ /rd/dignity/rock-audit.html, no campaign UTM), produced by the new optional `path` override in `_links.json` (places a stub at /<path>/ instead of /go/<slug>/). `_links.json` is the authoritative registry; this list is a convenience snapshot.
