...
**Repo:** `AngieQBailey/angieqbailey` | **Branch:** `main` | **Host:** GitHub Pages ÃÂ¢ÃÂÃÂ `angieqbailey.com`
...
| File | Purpose | Notes |
|------|---------|-------|
| `index.html` | Main site ÃÂ¢ÃÂÃÂ single file, all CSS/JS embedded | Contains Warehouse card grid, nav, hero, Debrief section, footer |
| `CNAME` | GitHub Pages custom domain config | Contains: `angieqbailey.com` |
| `README.md` | Minimal deployment notes | Not public-facing |
| `favicon.png` | AB monogram favicon, 192ÃÂÃÂ192 | Parisian Night bg, ecru text, quetzal-bright accent bar |
...
| `headshot.png` | Angie's portrait, 128ÃÂÃÂ128 | Footer easter egg ÃÂ¢ÃÂÃÂ opacity:0 default, reveals on footer hover |
| `og-image.png` | Social sharing preview, 1200ÃÂÃÂ630 | Blueprint-grid aesthetic, IBM Plex Mono, Parisian Night + quetzal grid + rosso accent |
...
| `posts/e-commerce-summit/assets/templates/dependency-friction-map-blank.html` | Blank template (light/ecru) | **LIVE** | ÃÂ¢ÃÂÃÂ |
| `posts/e-commerce-summit/assets/templates/expectations-sla-stress-test-blank.html` | Blank template (light/ecru) | **LIVE** | ÃÂ¢ÃÂÃÂ |
| `posts/e-commerce-summit/assets/templates/expectations-stress-test-blank.html` | Blank template (light/ecru) | **LIVE** | ÃÂ¢ÃÂÃÂ |
| `posts/e-commerce-summit/assets/templates/facilitation-mindsets-blank.html` | Blank template (light/ecru) | **LIVE** | ÃÂ¢ÃÂÃÂ |
| `posts/e-commerce-summit/assets/templates/pressure-points-register-blank.html` | Blank template (light/ecru) | **LIVE** | ÃÂ¢ÃÂÃÂ |
...
| File | Type | Status | Display Name |
|------|------|--------|--------------|
| `posts/ecommerce-pl/ecommerce-pl.html` | Case study page (dark) | **LIVE** | ÃÂ¢ÃÂÃÂ |
| `posts/ecommerce-pl/assets/pl-project-dossier.html` | Branded artifact page (dark) | **LIVE** | "Project Brief" (not "Dossier" ÃÂ¢ÃÂÃÂ file name uses dossier to preserve URL; all display text says Brief) |
...
| `posts/ecommerce-pl/assets/templates/pl-cutoff-definition-blank.html` | Blank template (light/ecru) | **LIVE** | ÃÂ¢ÃÂÃÂ |
...
| `posts/web-experience-capacity-build/assets/templates/team-capacity-diagnostic-blank.html` | Blank template (light/ecru) | **LIVE** | ÃÂ¢ÃÂÃÂ |
...
| File | Type | Status | Display Name |
|------|------|--------|--------------|
| `drs-matrix/index.html` | Framework page (light/ecru) | **LIVE** | "The 9:02 AM Meeting" (fable) + interactive DRS 2ÃÂÃÂ2 matrix widget |

**Notes:**
- This is NOT a case study ÃÂ¢ÃÂÃÂ it lives in the R&D section, not the client evidence grid
- Single self-contained HTML file with embedded CSS/JS, Google Fonts, and Plausible analytics
- URL: `angieqbailey.com/drs-matrix`
- Features: Mini-fable ("The 9:02 AM Meeting"), interactive 2ÃÂÃÂ2 matrix with click-to-expand detail panels, click-outside-to-close, scroll-reveal animation, Print/Save as PDF with dedicated print stylesheet
- Series card in Warehouse shows "Chunk 1 of 5" ÃÂ¢ÃÂÃÂ update as chunks ship
...
| File | Type | Status | Display Name |
|------|------|--------|--------------|
| `posts/enterprise-newsletter-architecture/enterprise-newsletter-architecture.html` | Case study page (dark) | **LIVE** | Ã¢ÂÂ |
...
| File | Type | Status | Display Name |
|------|------|--------|--------------|
| `posts/post-acquisition-integration-launch/post-acquisition-integration-launch.html` | Case study page (dark) | **LIVE** | â |
| `posts/post-acquisition-integration-launch/warehouse-card.html` | Warehouse card | **LIVE** | â |
...
| `posts/post-acquisition-integration-launch/assets/templates/system-integration-sequence-blank.html` | Blank template (light/ecru) | **LIVE** | â |
| `posts/post-acquisition-integration-launch/assets/templates/vendor-governance-model-blank.html` | Blank template (light/ecru) | **LIVE** | â |
| `posts/post-acquisition-integration-launch/assets/templates/product-taxonomy-architecture-blank.html` | Blank template (light/ecru) | **LIVE** | â |
...
| File | Type | Status | Display Name |
|------|------|--------|--------------|
| `posts/crisis-communications-architecture/crisis-communications-architecture.html` | Case study page (dark) | **LIVE** | â |
...
| File | Notes |
|------|-------|
| `posts/my-first-post.md` | Orphan ÃÂ¢ÃÂÃÂ not linked anywhere. Probably a GitHub default artifact. Do not delete without confirming with Angie. |

---

## Adding a New Case Study ÃÂ¢ÃÂÃÂ Checklist
